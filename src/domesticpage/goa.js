  ...
  const faqGoa = [
    {
        ...
        answer: "The last and early months of the year are when the majority of people want to travel to Goa."
    },
    {
        question: 'Why does positive energy constantly seem to flow through Goa?',
        answer: "This region is renowned for its churches, party culture, and beaches. Here, you might find vibrant churches and stunning beaches. Goa is the ideal merge of Indian and Portuguese cultures. People come here to enjoy the world-class parties, cuisines, and sunsets."
    },
    {
        question: 'What are the most admired Goa Tour Places to Visit?',
        answer: "The popular Goa Tour Places to Visit are Palolem Beach, Panaji, Vagator, Agonda, Calangute, Candolim, Anjuna, North Goa, and South Goa."
    },
    {
        question: 'How much is the approximate price for the Goa Tour Package From Chennai?',
        answer: "The price of the Goa Tour Package From Chennai can start from ₹9,500 to ₹29,500, based upon the itinerary's duration and package style."
    },
    {
        question: 'Can you customize Goa Tour Packages For Couples for us?',
        answer: "Yes, definitely! All of our tour packages are customizable based on the customer’s choice and trip style."
    },
    {
        question: 'How to choose the best Goa Tours and Packages?',
        answer: "The best Goa Tours and Packages will provide you with the greatest lodging and a wide range of sites to see. The best Goa tours and packages will leave you with amazing memories and be reasonably priced."
    },
    {
        question: 'How many beaches are covered in Goa Travel Packages?',
        answer: "Almost all the popular beaches are covered in our Goa Travel Packages. Some of them are Candolim Beach, Sinquerim Beach, Arambol Beach, Morjim Beach, Miramar Beach, Ashwem Beach, Mandrem Beach, Kalacha Beach, Dona Paula Beach, Vagator Beach, and Anjuna Beach."
    }
];
