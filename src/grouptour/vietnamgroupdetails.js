...
const TourSingapore = () => {
  ...
  const seoData = {
    ...
    keywords:
      "Vietnam Group Tour Packages, Vietnam Group Tour Packages from India, Vietnam Group Tour Packages from Chennai, Vietnam Group Tour, Vietnam",
    description:
      "The Vietnam Group Tour Packages takes you to the main cities such as Da Nang, Hanoi, and Ho Chi Minh City (Saigon), Hue, Hoi An, Nha Trang, Da Lat, and Mui Ne.",
    schema: {
      ...
      potentialAction: {
        "@type": "SearchAction",
        target:
          "https://www.capstoneholidays.in/tour/vietnam-group-tour-packages/{search_term_string}",
