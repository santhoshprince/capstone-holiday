  ...
  const tourDetails = {
    ...
    //   ],
      itinerary: [
        {
          day: "Day 1",
          details: "Welcome to Kazakhstan. On arrival in Almaty our local representative outside the baggage hall area at the airport. Proceed to the hotel. Check into your hotel (Standard Check in time after 1500Hrs). Later in the evening proceed for orientation tour followed by dinner. Return to hotel.",
        },
        {
          day: "Day 2",
          details:
            <>
            <p>Today after buffet breakfast, proceed on a guided tour to know more about history and development of the southern capital of Kazakhstan and see it's main attractions; First, visit the Zenkov Cathedral at Panfilov Park. Built in 1907, this century-old Russian Cathedral is the second-tallest wooden building in the world which is made without using any nails! Next, explore the historic Panfilov Park, named after the 28 soldiers of an Almaty infantry and marvel at the spectacular Eternal Flame monument.  </p>
            <p>
            The Central State Museum of the Republic of Kazakhstan, the Presidential Residence, the Republic Square and the Independence Monument, the Theater of Opera and Ballet named after Abai, Astana Square, Abai Square and the Palace of the Republic.Later make your way to the First President's Park and admire the beautiful gardens with flowers, the wonderfully layered fountain and spectacular views of majestic peaks.. After lunch visit Kok-Tobe, the highest TV tower in the world. A special viewing platform located on the mountain will allow you to admire the magnificent panorama of the city, as well as you can stroll along the winding paths of Kok-Tobe Park and visit souvenir shops. Return to hotel.
        ...
        },
        {
          ...
          details:
            <>
            <p>Today after buffet breakfast, proceed to Lake Issyk, a picturesque mountain lake surrounded by beautiful nature. The lake is located at an altitude of 1760 meters above sea level, in the Issyk gorge of the Trans-Ili Alatau, approximately 70 km east of Almaty. Admire the turquoise waters of the lake and the beauty of the Issyk gorge. </p>
            </>,
        },
        { day: "Day 6", details: <>
        
        <p>Today after breakfast at your hotel, proceed to the airport as this fantastic tour comes to an end. Return home with wonderful memories of your tour</p>
        </> },
      ],
      mapSrc:
      ...
      itinerary: [
        ...
        },
        {
          ...
          },
          {
            day: "Day 7",
            details:
              "Excursion to Jungfraujoch with Swiss pass with Entrance"
          },
          {
            day: "Day 8",
            details:
          ...
          },
          {
            day: "Day 9",
            details:
              "Private transfer in Zurich (Hotel - Airport)"
          },
      ],
      mapSrc:
